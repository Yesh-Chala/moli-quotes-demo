    ...
    <script>
        ...
        function parseProductName(fullName) {
            ...
            if (currentIndex < tokens.length) {
                ...
                if (seriesMatch) {
                    parsed.series = Number.parseInt(seriesMatch[0]);
                    currentIndex++;
                }
            }
        ...
        function extractCompletePricingDetails(bay) {
            ...
            if (pricingData.glazing.totalCost && productPricing.found && productPricing.productPrice) {
                ...
                console.log(`   📊 Total Estimate: $${completePricing.totalEstimate}`);
            }
                                            ...
                                            if (sash.apertures && sash.apertures[0]) {
                                                ...
                                                if (glazingProduct) {
                                                    ...
                                                    if (lowEMatches) {
                                                        ...
                                                        if (lowENumber) {
                                                            pricingData.glazing.lowECount = Number.parseInt(lowENumber[1]);
        ...
        function testProductPricing() {
            console.log('🧪 Testing Product Pricing System:');
            ...
            console.log('\n' + '='.repeat(50));
            console.log('✅ Product Pricing Test Complete!');
        }
