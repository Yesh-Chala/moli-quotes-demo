...
export default function GlazingPricingPage() {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-3xl font-bold text-gray-900">Glazing Pricing Management</h2>
              <p className="text-gray-600 mt-2">Set pricing for different glass types and specifications</p>
            </div>
          </div>
        </div>
